...
def detalhes_evento(request, evento_id):
    ...
    Alteração: select_related('status') adicionado + removida variável inscricoes_abertas
    Data: 20/02/2026
    """
    try:
    ...
    context = {
        ...
        # inscricoes_abertas REMOVIDO: template agora usa evento.status direto do banco
    }
